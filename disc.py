...
##########################################
# Discussion 11 Tail Recursion and Macros#
##########################################

# 2.1
"""Write a “macro” in Python called make lambda that takes in two parameters: params, a string containing a comma-separated list of variable names; and body, a Python expression in string form, and returns a lambda function that takes params as its parameters and body as its body."""
