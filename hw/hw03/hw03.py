...
def missing_digits(n):
    ...
    True
    """
    def cal_missing_digits(whole_but_last, last):
        if whole_but_last == 0:
            return 0
        elif last - whole_but_last % 10 <= 1:
            return cal_missing_digits(whole_but_last // 10, whole_but_last % 10)
        else:
            return cal_missing_digits(whole_but_last // 10, whole_but_last % 10) + last - whole_but_last % 10 - 1
    return cal_missing_digits(n // 10, n % 10)
...
def count_change(total):
    ...
    def count_partitions(n, m):
        if n == 0:
            ...
            with_m = count_partitions(n - 2**m, m)
            without_m = count_partitions(n, m-1)
            return with_m + without_m
        
    return count_partitions(total, max_power_of_two(total))
