...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            this_round_strategy = strategy0(score0, score1)
            this_round_score = take_turn(this_round_strategy, score1, dice)
            score0 += this_round_score
            if feral_hogs and abs(last_round_score0 - this_round_strategy) == 2:  
                score0 += 3
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            last_round_score0 = this_round_score
            say1 = say0(score0, score1)
        else:
            this_round_strategy = strategy1(score1, score0)
            this_round_score = take_turn(this_round_strategy, score0, dice)
            score1 += this_round_score
            if feral_hogs and abs(last_round_score1 - this_round_strategy) == 2:  
                score1 += 3
            if is_swap(score1, score0):
                score0, score1 = score1, score0
            last_round_score1 = this_round_score
    ...
    def say(score0, score1):
        ...
        if score > last_score:
            ...
            if running > running_high:
                running_h = running
                print(running_h, "point(s)! That's the biggest gain yet for Player", who)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_scoring = 0
    for i in range(10):
        this_num_scoring = make_averaged(roll_dice, trials_count)(i+1, dice)
        if this_num_scoring > max_scoring:
            max_scoring_num = i+1
            max_scoring = this_num_scoring
